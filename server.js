...
app.use('/api/auth/forgot-password',       sec.authLimiter);
app.use('/api/auth/admin/forgot-password', sec.authLimiter);
app.use('/api/auth/mentor/forgot-password', sec.authLimiter);
app.use('/api/auth/verify-otp',            sec.authLimiter);
app.use('/api/auth/reset-password',        sec.authLimiter);
